                ...
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    ...
                    <form method="POST" action="{{ route('auth.usuariopassreset.redirect') }}">
                        @csrf
                        <p><center>Ingresa tu Usuario</center></p>
                        <div class="form-outline mb-4">
                            <input type="text" id="NOM_USUARIO" name="NOM_USUARIO" class="form-control" oninput="this.value = this.value.toUpperCase()" 
                            placeholder="Usuario" value="{{ old('NOM_USUARIO') }}" required/>
                        </div>
